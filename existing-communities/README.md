...
Software communities are groups of people involved in the development or improvement of a piece of software, but can also be focussed on a programing language (model). This makes software communities a broad term. For this research, the focus will be put on Software Development Communities,  communities centered around software development/improvement. This means that further analysis of Software Engineering Communities,  communities centered around programing language (models), will not be included in this report.   
